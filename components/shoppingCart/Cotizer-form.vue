<template>
    ...
    <div class="d-flex flex-column">
       ...
       <span class="warn">*Los precios no incluyen IVA</span>
        <span class=" warn">*El minimo de compra ONLINE es de ${{configs.minbuy_ship}} </span>
               ...
               <div class="col-12 row form-group-row mt-2 mb-2 align-items-center">
                   ...
                   <div class="col-12 col-lg-4 row">
                       ...
                       <div class="col-12 row mt-1">
                           <input type="checkbox" style="height:20px" v-model="phone.whatsapp" class="col-1 form-control">
                           <label class="col-10"> Contactarme por Whatsapp <i class="fab fa-whatsapp"></i>  </label>
                       </div>
