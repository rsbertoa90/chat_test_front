...
<div v-if="product" class="d-flex justify-content-end">
    <button v-if="!product.units || product.units < 1 " type="button"  class="btn shop-button clickable bordered "  :class="{'small':small}" @click="addProduct"> 
